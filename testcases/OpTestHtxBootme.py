...
class OpTestHtxBootmeIO(unittest.TestCase):
    #self.current_method = func.__name__
    def setUp(self):
        """
        Setup
        """
        ...
        self.current_func = sys._getframe(  ).f_code.co_name
        if self.current_func.endswith('test_start'):
    ...
    def stop_htx(self):
        ...
        self.con.run_command(cmd, timeout=120)
