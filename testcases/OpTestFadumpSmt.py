...
#
# $Source: op-test-framework/testcases/OpTestFadumpSmt.py $
#
...
This module can contain testcases related to FAdump.
...
5. Repeat Step2 to Step4 for different SMT levels.
'''
...
class KernelCrash_FAdumpEnable(OpTestKernelBase):
    '''
