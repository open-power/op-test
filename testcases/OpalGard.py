...
class OpalGard(unittest.TestCase):
    ...
    def show_gard_record(self, id):
        ...
        try:
            ...
            print str(cf)
            self.gather_debug_logs()
            raise Exception("show gard records operation failed")

    def gather_debug_logs(self):
	...
	self.cv_SYSTEM.host_console_unique_prompt()
        ...
        for i in range(0, 11):
            ...
            self.c.run_command("dd if=/tmp/fake.gard of=/dev/mtd0 bs=$((0x10)) seek=$((0x2c00)) conv=notrunc")
            self.list_gard_records()
