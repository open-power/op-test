...
class OpTestIPMILockMode():
    ...
    def run_inband_ipmi_whitelisted_cmds(self):
        ...
        # 19. [App] Get ACPI Power State (0x06)
        ...
        # 22. [Sensor/Event] Get Sensor Type
        ...
        # 23.[Sensor/Event] Get Sensor Reading
        ...
        # 24.[Sensor/Event] Platform Event (0x02)
        ...
        # 25. [OEM] PNOR Access Response (0x08)
