...
class OpTestConstants():
    ...
    CAPP_PART_MEASURED = "CAPP partition measured"
    CAPP_PART_NOT_MEASURED = "CAPP partition not measured"
    BOOTKERNEL_MEASURED = "STB: BOOTKERNEL sha"
    BOOTKERNEL_PART_MEASURED = "BOOTKERNEL partition measured"
    BOOTKERNEL_PART_NOT_MEASURED = "BOOTKERNEL partition not measured"
    CAPP_VERIFIED = "STB: CAPP verified"
    CAPP_PART_VERIFIED = "CAPP partition verified"
    CAPP_PART_NOT_VERIFIED = "CAPP partition not verified"
    BOOTKERNEL_VERIFIED = "STB: BOOTKERNEL verified"
    BOOTKERNEL_PART_VERIFIED = "BOOTKERNEL partition verified"
    BOOTKERNEL_PART_NOT_VERIFIED = "BOOTKERNEL partition not verified"
    CAPP_LOADED = "CAPP ucode lid loaded"
    CAPP_PART_LOADED = "CAPP partition loaded"
    CAPP_PART_NOT_LOADED = "CAPP partition not loaded"
    BOOTKERNEL_LOADED = "INIT: Kernel loaded"
    BOOTKERNEL_PART_LOADED = "BOOTKERNEL partition loaded"
    BOOTKERNEL_PART_NOT_LOADED = "BOOTKERNEL partition not loaded"
    ON = "on"
    OFF = "off"
    ...
    STB_DT_DIR = "ibm,secureboot"
    TB_DT_ENTRY = "ibm,secureboot/trusted-enabled"
    SB_DT_ENTRY = "ibm,secureboot/secure-enabled"
    P8_SB_VERSION = "ibm,secureboot-v1"
