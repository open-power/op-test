...
from Exceptions import CommandFailed, RecoverFailed, ConsoleSettings, HostLocker, AES, ParameterCheck, HTTPCheck
...
class OpTestUtil():
    ...
    def PingFunc(self, i_ip, i_try=1, totalSleepTime=BMC_CONST.HOST_BRINGUP_TIME):
        if i_ip == None:
            # it can be too early in config bootstrap to call util.cleanup()
            raise ParameterCheck(msg="PingFunc fails with None as i_ip, "
                "check your configuration and manually verify and "
