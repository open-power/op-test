...
class DynamicKeyGuestSecureBoot(unittest.TestCase):
    def setUp(self):
        ...
        try:
            ...
            try:
                ...
                log.warning(f"Failed to install binutils: {install_error}")
    ...
    def configure_keystore_params(self, config_params):
        """Configure keystore parameters via HMC"""
        command = f"chsyscfg -r lpar -m {self.cv_HMC.mg_system} -i \"name={self.cv_HMC.lpar_name}, {config_params}\""
        self.cv_HMC.ssh.run_command(command, timeout=300)
    ...
    def setup_dynamic_secure_boot(self):
        ...
        try:
            ...
            self.configure_keystore_params(config_params)
    ...
    def reset_secure_boot(self):
        ...
        try:
            ...
            # Now configure keystore-related params to zero
