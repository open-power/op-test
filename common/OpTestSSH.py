...
class OpTestSSH():
    ...
    def __init__(self, host, username, password, logfile=sys.stdout, port=22,
        ...
        # ssh port 2200 console tracking not done on SSH object, its done on
        # System object for the system console
        self.PS1_set = -1
        self.LOGIN_set = -1
        self.SUDO_set = -1
    ...
    def connect(self):
        ...
        # For multi threades SSH sessions use individual logger and file
        # handlers per session.
        ...
        # delay here in case messages like afstokenpassing unsupported show up
        # which mess up setup_term
        time.sleep(2)
        self.check_set_term()
        return self.pty
